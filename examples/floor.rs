use diploma_thesis::{ controll::camera::fly_camera::FlyCameraController, res::{asset_manager::AssetManager, texture::{self, gpu_texture::DEPTH_FORMAT},  vertex::Vertex}, scene::{camera::get_camera_bind_group_layout, entity::SceneEntity}};
use gltf::Gltf;
...
async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    // Вершины для пола
    let floor_vertices = [
        // позиция, UV координаты
        [-10.0, -1.0, -10.0, 0.0, 0.0],
        [ 10.0, -1.0, -10.0, 10.0, 0.0],
        [ 10.0, -1.0,  10.0, 10.0, 10.0],
        [-10.0, -1.0,  10.0, 0.0, 10.0],
    ];

    let floor_indices = [0, 1, 2, 0, 2, 3];
        ...
        match event {
            ...
            Event::WindowEvent {
            ...
            
                {
                    ...
                    render_pass.set_pipeline(&floor_pipeline);
                    ...
                    render_pass.draw_indexed(0..floor_indices.len() as u32, 0, 0..1);
